...
void kernel aLearn(
    ...
    if (hiddenPosition.z == hiddenSize.z)
        ...
        float delta = (deltaAction > 0.0f ? 1.0f : -1.0f) * ((hiddenPosition.z == hiddenCPrev ? 1.0f : 0.0f) - sigmoid(hiddenActivationsPrev[address3(hiddenPosition, hiddenSize)] * rescale));

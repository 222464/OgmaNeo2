...
namespace ogmaneo {
    /*!
    \brief A predictor layer
    Maps input CSDRs to predictions of next state
    */
    class Predictor {
    public:
        /*!
    ...
    public:
        /*!
        \brief Prediction learning rate
        */
        float _alpha;
        ...
        */
        ...
        \param hiddenTargetCs target states. Set to null if no learning is to take place
        */
        void step(ComputeSystem &cs, const std::vector<const IntBuffer*> &visibleCs, const IntBuffer* hiddenTargetCs);
        ...
        */
        ...
        \brief Get the weights for a visible layer
        */
        const IntBuffer &getInputCsPrev(int v) {
            return _visibleLayers[v]._inputCsPrev;
        }
    };
}
